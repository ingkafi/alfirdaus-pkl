...
<head>
    ...
    <!-- Sweet Alert -->
    <!--Calendar-->
    <script src="{{ URL::asset('calendar/js/moment.min.js') }}"></script>
    <script src="{{ URL::asset('calendar/js/jquery.min.js') }}"></script>
    ...
    <link href="{{ URL::asset('assets/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet"
        type="text/css">
    <!-- Custom CSS -->
    <link href="{{ URL::asset('assets/dist/css/style.min.css') }}" rel="stylesheet" type="text/css">
</head>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/kelola/siswa" aria-expanded="false">
                                <i data-feather="users" class="feather-icon"></i>
                                <span class="hide-menu">Siswa</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/admin/kelola/user" aria-expanded="false">
                                <i data-feather="users" class="feather-icon"></i>
                                <span class="hide-menu">User</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/kelola/parent" aria-expanded="false">
                                <i data-feather="users" class="feather-icon"></i>
                                <span class="hide-menu">Parent</span></a>
                        </li>
                        {{-- <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/kelola/grade" aria-expanded="false">
                                <i data-feather="grid" class="feather-icon"></i>
                                <span class="hide-menu">Grade</span></a>
                        </li> --}}
                        {{-- <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/kelola/raport" aria-expanded="false">
                                <i data-feather="file-text" class="feather-icon"></i>
                                <span class="hide-menu">Raport</span></a>
                        </li> --}}
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/admin/profile" aria-expanded="false">
                                <i data-feather="user" class="feather-icon"></i>
                                <span class="hide-menu">Edit Profil</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="/admin/password" aria-expanded="false">
