            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            <label for="judul" class="block">Title</label>
                        ...
                        <div class="mb-2">
                            <label for="isi" class="block">Description</label>
                            <textarea wire:model="isi" name="isi"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900"
                                placeholder="Input Post"></textarea>
                            @error('isi') <h1 class="text-red-500">{{ $message }}</h1>@enderror
                        </div>
                    </div>
                </div>
